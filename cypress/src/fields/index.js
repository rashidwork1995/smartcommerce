...
export const quickOrderMultipleSkuContainer =
  ".quick-order-multiple-sku-container";
export const quickOrderCsvUploadContainer = ".quick-order-csv-upload-container";
export const quickOrderMultipleSkuTextarea =
  'textarea[data-testid="dropin-textarea-field"]';
export const quickOrderCsvFileInput = "input#quick-order-csv-file-input";
export const quickOrderCsvErrorMessage =
  ".b2b-quick-order-csv-file-input__error";
export const quickOrderItemCard =
  ".b2b-quick-order-form-quick-order-items__item-form";
export const quickOrderItemQuantityInput =
  'input.dropin-incrementer__input[name="quantity"]';
export const quickOrderItemRemoveButton =
  'button[data-testid="cart-item-remove-button"]';
...
export const quickOrderAddAllToCartButton =
  'button[data-testid="add-all-to-cart-button"]';
...
export const variantsGridAddToCartButton =
